...
<div style="border: 5px solid #ccc; border-radius: 30px; padding: 10px;">
	...
	<div class="form-group">
    <label for="product" class="col-sm-2 control-label">분류</label>
    <div class="col-sm-6">
        <select 	name="category"		class="ct_input_g" 
				...
				<option value="식물/화분">식물/화분</option>
		  ...
		  <div class="form-group">
   			<label for="product" class="col-sm-2 control-label">이미지 삽입</label>
   			 <div class="col-sm-5">
            <input type="file" class="form-control" id="imagefile" name="imagefile" value="C:/workspace/miniproject/src/main/resources/static/images/uploadFiles">
      	  </div>
    	</div>
