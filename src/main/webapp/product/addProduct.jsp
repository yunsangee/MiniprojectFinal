    ...
    <div class="col-sm-6">
        <input type="text" class="form-control" id="prodDetail" name="prodDetail"  placeholder="${product.prodDetail }">
		  ...
		  <div class="form-group">
		   ...
		   <div class="form-group">
		    <label for="product" class="col-sm-2 control-label">카테고리</label>
		    <div class="col-sm-4">
  			  <input type="text" class="col-sm-6 form-control" id="category" name="category" placeholder="${product.category }"/>
  				</div>
		  </div>
