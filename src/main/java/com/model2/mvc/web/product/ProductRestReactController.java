...
public class ProductRestReactController {
	...
	public ProductRestReactController(){
	...
	@RequestMapping(value="react/addProduct", method=RequestMethod.POST)
	...
	@RequestMapping( value="react/getProduct/{prodNo}", method=RequestMethod.GET )
	...
	@RequestMapping(value="react/listProduct")
